...
class Drone2dEnv(gym.Env):
    ...
    def __init__(
        ...
        platform_speed=1.5,
        initial_pos_random_range_m=5.0,
        max_allowed_tilt_angle_rad=np.pi / 2.0,
        enable_wind=True,
    ):  # Default: Wind is enabled
        ...
        # --- Wind Parameters --- MODIFIED
        self.enable_wind = enable_wind
        self.wind_speed = 5.0 if self.enable_wind else 0.0  # Set speed based on flag
        self.wind_force_coefficient = 0.5
        # self.wind_direction initialized in seed()
        # --- End Wind Parameters ---
        ...
        self.screen_height_px = 800  # Reverted size for consistency
